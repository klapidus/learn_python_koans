...
def test_create():
    ...
    my_set = {'hi', 'bye', 'hallo'}  # попробуйте такие варианты: set(), {1, 2, 3}, {'qwerty'}, set((1, 2, 3))
...
def test_words_in_set():
    ...
    """
    my_set = {True, False, 'dummy', 34, 78.0}  # попробуйте такие варианты: {True, 'set', 2}, {'cow', 'fox', 'cat'}
    assert isinstance(my_set, set)
